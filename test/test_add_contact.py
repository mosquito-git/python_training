...
def test_add_contact1(app):
    ...
    cont = contact.Contact(firstname="aaaaa", middlename="bbbbb", lastname="ssssss",
    ...
    assert sorted(old_contacts, key=contact.Contact.id_or_max) == sorted(new_contacts, key=contact.Contact.id_or_max)
