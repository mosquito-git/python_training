...
def test_add_contact1(app):
    ...
    app.create_contact(contact.Contact(firstname="aaaaa", middlename="bbbbb", lastname="ssssss",
...
def test_add_empty_contact(app):
    app.login(username="admin", password="secret")
    app.create_contact(contact.Contact(firstname="", middlename="", lastname="", nickname="", title="", company="",
